...
/**
 * Contains all data type mappings, health record classifications, and type conversions used
...
object HealthConstants {
         ...
         * operations. Used when requesting aggregated data over time periods.
         *
         * @return Map<String, AggregateMetric> Mapping for aggregate data queries
         */
        val mapToAggregateMetric =
                hashMapOf(
        ...
        /**
         * Maps integer sleep stage values to their corresponding data type strings. Converts Health
         * Connect sleep stage enumeration to Flutter-friendly string constants.
         *
        ...
        /**
         * Maps meal type strings to Health Connect MealType enumeration values. Enables conversion
         * from Flutter meal type strings to Health Connect types.
         *
         * @return Map<String, MealType> Meal type string to enum mapping
         */
        val mapMealTypeToType =
                hashMapOf(
        ...
        /**
         * Maps Health Connect MealType enumeration values back to Flutter string constants. Used
         * for converting Health Connect meal types to Flutter-compatible format.
         *
         * @return Map<MealType, String> Enum to string mapping for meal types
         */
        val mapTypeToMealType =
                hashMapOf(
