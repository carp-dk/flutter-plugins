...
object HealthConstants {
    ...
    /**
     * Maps meal type strings to Health Connect MealType enumeration values. Enables conversion from
     * Flutter meal type strings to Health Connect types.
     *
    ...
    /**
     * Maps Health Connect MealType enumeration values back to Flutter string constants. Used for
     * converting Health Connect meal types to Flutter-compatible format.
     *
