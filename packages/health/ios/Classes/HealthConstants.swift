...
enum HealthConstants {
    ...
    static let CERVICAL_MUCUS_QUALITY = "CERVICAL_MUCUS_QUALITY"
    static let OVULATION_TEST_RESULT = "OVULATION_TEST_RESULT"
    static let PREGNANCY_TEST_RESULTS = "PREGNANCY_TEST_RESULTS"
    static let INTERMENSTRUAL_BLEEDING = "INTERMENSTRUAL_BLEEDING"
